...
if __name__ == "__main__":
    ...
    # Schritt 2: Testen der Modelle (inkl. ursprüngliches Keras-Modell)
    test_validator = TestOptimizedModels()
    test_validator.run_full_validation(
        normal_model_path="src/edgeDevice/models/model.tflite",
        quantized_model_path="src/edgeDevice/models/model_quantized.tflite",
        keras_model_path="src/srv/models/best_model.h5"
    )